...
public  class WorkBookGeneratorHelper {
    ...
    private WorkBookGeneratorHelper() {
        throw new IllegalStateException("Utility class");
    }

    public static XSSFWorkbook generateFrom(Campaign campaign, Survey survey) {
    ...
    private static void createNumberOfSurveyRow(Campaign campaign, Sheet sheet) {
        Cell cell;
        Row row;
    ...
    private static void createSectionClientRow(Sheet sheet, CellStyle titleStyle) {
    ...
    private static void createClientRow(Survey survey, Sheet sheet, CellStyle style) {
    ...
    private static void createClientAddressLabelRow(Survey survey, Sheet sheet, CellStyle style) {
    ...
    private static void createSurveyRow(Sheet sheet, CellStyle style) {
    ...
    private static int createAddressStatusRow(Sheet sheet, CellStyle style, int startIndex, int currentIndex, AddressStatus addressStatus) {
